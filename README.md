...
### PACKAGE
---
EVERY GO PROGRAM IS MADE UP OF PACKAGES WHICH IS MADE UP OF ALL THE FILES IN THE SAME DIRECTORY
```Go
package main
```
...
### DEPENDENCY TRACKING
===
TO IMPORT EXTERNAL PACKAGES BY CREATING go.mod AT ROOT OF THE PROJECT (ALSO CREATES go.sum WHICH IS HASH BITS OF DEPENDENCIES)
> go mod init {NAME OF YOUR MODULE EX. github.com/{USERNAME}/MOUDLE_REPO}

AFTER IMPORTING A EXTERNAL MODULE(S), THE MOD WILL LOCATE AND DOWNLOAD THE PACKAGE
> go mod tidy
